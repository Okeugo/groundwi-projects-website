        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredServices.map((service) => (
            <div
              ...
              className="group flex flex-col justify-between rounded-2xl bg-white hover:bg-slate-50/60 border border-slate-200 hover:border-[#00A3E8]/50 p-6 transition-all duration-200 shadow-xs hover:shadow-lg relative"
            >
              <div>
