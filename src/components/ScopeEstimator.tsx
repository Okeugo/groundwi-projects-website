...
export const ScopeEstimator: React.FC<ScopeEstimatorProps> = ({
  ...
  return (
    <section id="scope-estimator" className="py-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 p-6 sm:p-8 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-xs">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`p-3.5 rounded-xl border text-left transition-all ${
                      mode === opt.id
                        ? 'bg-white dark:bg-slate-900 border-[#00A3E8] text-slate-900 dark:text-white shadow-sm ring-2 ring-[#00A3E8]/20'
                        : 'bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200'
                    }`}
                  >
                    <span className="text-xs font-bold block text-slate-900 dark:text-white">{opt.label}</span>
                    <span className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 block">{opt.desc}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-[#00A3E8]"
                >
                ...
                {['< 5 Hectares', '5 - 25 Hectares', '25 - 100 Hectares', '100+ Ha / Linear Corridor'].map((fp) => (
                  <button
                    ...
                    className={`py-2 px-3 rounded-lg border text-center transition-all ${
                      footprint === fp
                        ? 'bg-white dark:bg-slate-900 border-[#00A3E8] text-[#007ea8] font-bold shadow-xs'
                        : 'bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'
                    }`}
                  >
                    {fp}
                  </button>
                  ...
                  return (
                    <button
                      ...
                      className={`p-3 rounded-xl border text-left flex items-start gap-3 transition-all ${
                        isChecked
                          ? 'bg-white dark:bg-slate-900 border-[#00A3E8]/60 text-slate-900 dark:text-white shadow-xs'
                          : 'bg-white dark:bg-slate-900/60 border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:text-slate-200'
                      }`}
                    >
                      ...
                      <div>
                        <span className="text-xs font-semibold block text-slate-900 dark:text-white">{disc.name}</span>
                        <span className="text-[10px] text-slate-500 dark:text-slate-400">{disc.tag}</span>
                      </div>
                    </button>
                  );
                })}
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-gradient-to-b from-slate-50 via-white to-slate-50 border border-[#00A3E8]/30 shadow-md flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-xs space-y-2">
              ...
              {/* Turnaround Estimate */}
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-xs flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs font-bold text-slate-900 dark:text-white">{timeline}</span>
                </div>
              </div>

              {/* Recommended Sensor / Rig Suite */}
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-xs space-y-1.5">
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-700">
              <button
                ...
                className="w-full py-3.5 px-4 rounded-xl text-xs sm:text-sm font-bold text-slate-950 dark:text-white bg-gradient-to-r from-[#FF721F] to-[#F7BA1E] hover:from-[#ff8134] hover:to-[#f8c339] transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 active:scale-[0.98]"
              >
