...
export const PartnersSection: React.FC<PartnersSectionProps> = ({ onPartnerInquiry }) => {
  ...
  return (
    <div className="py-12 sm:py-16 bg-white text-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight font-['Space_Grotesk']">
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3 text-left">
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-xs">
              ...
              <div className="text-xs text-slate-500 mt-0.5">OEM Factory Calibrated</div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-xs">
              <div className="text-xl font-bold text-[#FF721F] font-['Space_Grotesk']">ISO 17025</div>
              <div className="text-xs text-slate-500 mt-0.5">Accredited Materials Labs</div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-xs">
              <div className="text-xl font-bold text-[#e69800] font-['Space_Grotesk']">Sub-cm</div>
              <div className="text-xs text-slate-500 mt-0.5">RTK GNSS Precision</div>
            </div>
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-xs">
              <div className="text-xl font-bold text-emerald-700 font-['Space_Grotesk']">Zero</div>
              <div className="text-xs text-slate-500 mt-0.5">Uncalibrated Tooling</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10 space-y-4">
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-200 shadow-xs">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all ${
                    selectedCategory === cat.id
                      ? 'bg-gradient-to-r from-[#00A3E8] to-[#0092d0] text-slate-950 font-bold shadow-sm'
            ...
            <div className="relative min-w-[240px] shrink-0">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-xs rounded-xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#00A3E8] transition-colors"
              />
              {searchQuery && (
                <button
          ...
          <div className="flex items-center justify-between text-xs text-slate-500 px-1">
            <span>
              Showing <strong className="text-slate-900">{filteredPartners.length}</strong> technology & testing partner{filteredPartners.length === 1 ? '' : 's'}
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredPartners.map((partner) => (
            <div
              key={partner.id}
              className="p-6 rounded-2xl bg-white border border-slate-200 hover:border-[#00A3E8]/50 transition-all duration-300 flex flex-col justify-between group hover:shadow-xl hover:shadow-cyan-100/50"
            >
              <div>
                {/* Card Header: Category & Tier */}
                <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-100 text-slate-800 border border-slate-200">
                ...
                <h3 className="text-xl font-bold text-slate-900 group-hover:text-[#007ea8] transition-colors font-['Space_Grotesk']">
                  {partner.name}
                </h3>
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold text-slate-700 bg-slate-100 hover:bg-[#00A3E8] hover:text-slate-950 transition-colors"
                >
        ...
        <div className="mt-16 p-8 sm:p-10 rounded-3xl bg-slate-50 border border-slate-200 shadow-sm relative overflow-hidden">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4">
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-slate-950 bg-gradient-to-r from-[#FF721F] to-[#F7BA1E] hover:from-[#ff8134] hover:to-[#f8c339] shadow-lg shadow-orange-500/20 transition-all flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-slate-700 bg-white hover:bg-slate-100 border border-slate-300 transition-colors shadow-xs"
              >
